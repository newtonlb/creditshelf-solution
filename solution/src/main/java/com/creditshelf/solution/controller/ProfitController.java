...
public class ProfitController {
    ...
    @ResponseBody
    private RevenueReportDTO getrevenuesReportByCompany( @RequestParam("companyName") String companyName) {
        return profitReportService.getProfitReportByCompany(companyName);
    }
